...
/** POST /users/:username/job/:id  => { applied: id } 
 * 
 * returns applied message with job id
 * 
 * adds and application for the username and job id
 * 
 ...
 * Where jobs is [jobId...]
 *
 * Authorization required: admin or requested user
 **/
